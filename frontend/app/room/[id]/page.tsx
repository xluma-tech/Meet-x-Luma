  ...
  useEffect(() => {
    ...
    const connectToRoom = async () => {
      try {
        ...
        // Define event handlers inline to capture roomInstance
        ...
        const handleTrackSubscribed = (track: any, publication: any, participant: Participant) => {
          ...
          // Force re-render to update video tiles
          if (roomInstance) {
            const allParticipants = [
              roomInstance.localParticipant,
              ...Array.from(roomInstance.remoteParticipants.values()),
            ...
            setParticipants(allParticipants);
            console.log('👥 Updated participants after track subscription:', allParticipants.length);
          }
        };
        ...
        const handleTrackMuted = (publication: any, participant: Participant) => {
          console.log('🔇 Track muted:', publication.kind, 'from', participant.identity);
          setParticipants(prev => [...prev]);
        };

        const handleTrackUnmuted = (publication: any, participant: Participant) => {
        ...
        if (!isMounted) {
          console.log('⚠️ Component unmounted after connect, disconnecting');
